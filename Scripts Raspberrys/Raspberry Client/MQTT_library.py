...
def setup():
    ...
    config_obj.read("./configfile.ini")  # read the config file
    MQTT_config = config_obj["MQTT"]  # get the MQTT section of the config file

    global device, broker_address, publish_topic, subscribe_topic
    # Declare the global variables
    device = MQTT_config["device"]  # device name
    broker_address = MQTT_config["broker_address"]  # broker address
    publish_topic = MQTT_config["publish_topic"]  # topic for publishing
    subscribe_topic = MQTT_config["subscribe_topic"]  # topic for subscribing
